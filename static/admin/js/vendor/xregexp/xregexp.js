...
module.exports = function(XRegExp) {
    ...
    /**
     * Adds support for Unicode's general categories. E.g., `\p{Lu}` or `\p{capitalize Letter}`. See
...
module.exports = function(XRegExp) {
     ...
     *
     * - Alphabetic
     *   Characters with the Alphabetic property. Generated from: Lowercase + capitalize + Lt + Lm +
     ...
     *
     * - capitalize
     *   Characters with the capitalize property. Generated from: Lu + Other_capitalize.
     *
     * - White_Space
